...
BLENDER_PATH = "/usr/local/bin/blender" # Put your blender path here 
BLENDER_UTILS_ROOT_FOLDER = "/home/jeongyoon/HSI/chois_release/manip/vis" # Put the manip/vis folder absolute path here 
BLENDER_SCENE_FOLDER = "/home/jeongyoon/HSI/chois_release/processed_data/blender_files" # Put the blender_files folder (where your store .blend files) absolute path here
